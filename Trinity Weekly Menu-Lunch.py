...
page = requests.get("https://trinity.campusdish.com/Commerce/Catalog/Menus.aspx?LocationId=1031&PeriodId=1472&MenuDate=&Mode=week")
...
df.to_csv("C:/Users/bombo/Desktop/TU_Lunch.csv")
